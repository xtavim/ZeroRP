...
RegisterNetEvent("police_dispatch:client:shootingDispatch", function(title, code, location, coords, gender, weapon, vehicleName, vehicle)
...
RegisterNetEvent("police_dispatch:client:customDispatch", function(title, code, location, coords, gender, vehicleName, vehicle, weapon, blipSprite)
    local distance = GetDistanceBetweenCoords(coords, GetEntityCoords(PlayerPedId()), false)
    local paint, primaryId, secondaryId, primary, secondary
