...
Config = {
	...
	Locations =  {
		['MineStore'] = {
			...
			{ name = "Mina", coords = vector4(2960.9, 2754.14, 43.71, 204.58), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
			{ name = "Loja de Minérios", coords = vector4(1074.89, -1988.19, 30.89, 235.07), sprite = 436, col = 1, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		},
		['Smelter'] = {	 -- The location of the smelter
			{ name = "Forja", coords = vector3(1112.29, -2009.9, 31.46), sprite = 436, col = 1, blipTrue = true, },
		},
		--[[ ["Washing"] = {
		...
		['Cracking'] = { -- The location of the smelter
			{ name = "Partir Pedra", coords = vector4(1109.19, -1992.8, 30.98, 146.88), sprite = 566, col = 81, blipTrue = true, prop = `prop_vertdrill_01` }, -- Foundary
			{ name = "Partir Pedra", coords = vector4(1105.56, -1992.53, 30.94, 238.19), sprite = 566, col = 81, blipTrue = true, prop = `prop_vertdrill_01` }, -- Foundary
		},
		['OreBuyer'] = { -- The Locations of the ore buyers
			{ name = "Venda de Minérios", coords = vector4(1090.18, -1999.51, 30.93, 146.24), sprite = 568, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		['JewelCut'] = { -- The Location of the jewel cutting bench. Couldn't decide so left in smeltery
			{ name = "Corte de Jóias", coords = vector4(1077.11, -1984.22, 31.02, 235.8), sprite = 566, col = 81, blipTrue = true, prop = `gr_prop_gr_speeddrill_01c` },
			{ name = "Corte de Jóias", coords = vector4(1075.19, -1985.45, 30.92, 144.89), sprite = 566, col = 81, blipTrue = true, prop = `gr_prop_gr_speeddrill_01c` },
		},
		['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
			{ name = "Venda de Jóias", coords = vector4(-629.86, -240.35, 38.16, 110.05), sprite = 527, col = 617, blipTrue = true, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		}, 
	},
...
--Mining Store Items
	Items = {
		label = "Loja de Mineração",  slots = 9,
		items = {
